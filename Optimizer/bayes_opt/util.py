...
def get_rnd_quantities(max_amount, dimension):
    ...
    '''
    return get_rnd_simplex(dimension) * np.random.uniform(0,max_amount)

# print(get_rnd_simplex(4))

if __name__ == "__main__":
    for i in range(10):
        print(get_rnd_quantities(4.5, 6))